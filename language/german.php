...
$languages['german'] = array (
    ...
    "error_device_limit" => "Sie haben die maximale Anzahl an Geräten für Ihr Benutzerkonto erreicht",
    "error_insert_device" => "Datenbank-Fehler beim Speichern des Gerätes, bitte versuchen Sie es später nochmals",
    "api_token_section" => "API-Zugang",
    "api_token_label" => "Ihr API-Token:",
    "api_token_new" => "Ihr neues Token (jetzt kopieren – es wird nicht erneut angezeigt):",
    "api_token_regen" => "Neues Token generieren",
    "api_token_has_token" => "Ein Token ist gesetzt. Generieren Sie ein neues Token, um es zu ersetzen.",
    "api_token_hint_notice" => "Dies ist nur ein Teilhinweis — um das vollständige Token zu sehen, generieren Sie ein neues.",
    "api_token_none" => "Noch kein API-Token vorhanden. Klicken Sie auf die Schaltfläche unten, um eines zu generieren.",
    "api_token_doc_notice" => "Weitere Informationen zur API finden Sie unter:",
