...
$languages['dutch'] = array (
    ...
    "error_device_limit" => "U heeft het maximale aantal apparaten voor uw account bereikt",
    "error_insert_device" => "Databasefout bij het opslaan van het apparaat, probeer het later opnieuw",
    "api_token_section" => "API Toegang",
    "api_token_label" => "Uw API-token:",
    "api_token_new" => "Uw nieuwe token (kopieer het nu, het wordt niet meer getoond):",
    "api_token_regen" => "Nieuw token genereren",
    "api_token_has_token" => "Er is een token ingesteld. Genereer een nieuw token om het te vervangen.",
    "api_token_hint_notice" => "Dit is slechts een gedeeltelijke hint — om het volledige token te zien, genereer een nieuw token.",
    "api_token_none" => "Nog geen API-token. Klik op de knop hieronder om er een te genereren.",
    "api_token_doc_notice" => "Voor meer informatie over de API, raadpleeg:",
