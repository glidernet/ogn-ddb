...
$languages['english'] = array (
    ...
    "error_insert_device" => "Database error while saving device, please retry later",
    "error_owner" => "You must be the owner of the device",
    "error_device_limit" => "You have reached the maximum number of devices allowed for your account",
    "api_token_section" => "API Access",
    "api_token_label" => "Your API token:",
    "api_token_new" => "Your new token (copy it now, it won't be shown again):",
    "api_token_regen" => "Generate new token",
    "api_token_has_token" => "A token is set. Generate a new one to replace it.",
    "api_token_hint_notice" => "This is only a partial hint — to see the full token, generate a new one.",
    "api_token_none" => "No API token yet. Click the button below to generate one.",
    "api_token_doc_notice" => "For more information about the API, refer to:",
