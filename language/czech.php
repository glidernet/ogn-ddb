...
$languages['czech'] = array (
    ...
    "error_device_limit" => "Dosáhli jste maximálního počtu zařízení pro váš účet",
    "error_insert_device" => "Chyba databáze při ukládání zařízení, opakujte prosím později",
    "api_token_section" => "Přístup přes API",
    "api_token_label" => "Váš API token:",
    "api_token_new" => "Váš nový token (zkopírujte ho nyní, nebude znovu zobrazen):",
    "api_token_regen" => "Vygenerovat nový token",
    "api_token_has_token" => "Token je nastaven. Vygenerujte nový token pro jeho nahrazení.",
    "api_token_hint_notice" => "Toto je pouze částečný náhled — pro zobrazení celého tokenu vygenerujte nový.",
    "api_token_none" => "Zatím žádný API token. Klikněte na tlačítko níže pro jeho vygenerování.",
    "api_token_doc_notice" => "Více informací o API naleznete na:",
